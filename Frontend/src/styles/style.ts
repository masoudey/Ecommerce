const styles = {
    ...
    productDiscountPrice: 'font-bold text-[18px] font-Roboto',
    ...
    button: 'w-[150px] dark:bg-slate-300 bg-slate-700 h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    cart_button:
        'px-[20px] h-[38px] rounded-[20px] bg-[#f63b60] flex items-center justify-center cursor-pointer',
    cart_button_text:
        'dark:text-slate-300 text-slate-700 text-[16px] font-[600]',
